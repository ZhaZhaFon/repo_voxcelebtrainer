...
vox1_resl-sap_triplet-m0.1-rank10prob0.5:
	python3 trainSpeakerNet.py --gpu "2" --trainfunc triplet --margin 0.1 --nPerSpeaker 2 --save_path "/home/zzf/experiment-voxcelebtrainer/vox1_resl-sap_triplet-m0.1-rank10prob0.5" --config ./base0318.yml
vox1_resl-sap_triplet-m0.1-semi10:
	python3 trainSpeakerNet.py --gpu "3" --trainfunc triplet --margin 0.1 --nPerSpeaker 2 --hard_rank -1 --save_path "/home/zzf/experiment-voxcelebtrainer/vox1_resl-sap_triplet-m0.1-semi10" --config ./base0318.yml